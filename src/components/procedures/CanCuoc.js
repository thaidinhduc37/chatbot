...
import flowData from '../../domains/cancuoc/flow.json';
...
function CanCuoc() {
    ...
    const handleBack = () => {
        if (currentFlow) {
            ...
            // Find previous question based on flow structure
    ...
    return (
        <div className={cx('wrapper')}>
            <h2>Thủ tục Căn cước công dân</h2>
            {renderContent()}
        </div>
    );
}
